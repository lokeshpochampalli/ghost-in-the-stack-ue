...
gate = spawn(unreal.GitsSectorGate, (1350, 995, 0), rot=(0, 90, 0), label="Gate_Sector2")
gate.frame.set_static_mesh(mesh("SM_Kit_DoorFrame"))
gate.panel.set_static_mesh(mesh("SM_Kit_DoorPanel"))
gate.set_editor_property("door_key", "door.inner")
gate.set_editor_property("next_level", "/Game/Sectors/L_Sector2_Greenhouse")
gate.set_editor_property("label", "SECTOR 2  GREENHOUSE")
gate.set_editor_property("sealed_line", "Sealed. Eight systems in this sector, and the airlock opens on the eighth.")
