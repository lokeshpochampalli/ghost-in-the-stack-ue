@echo off
rem Runs the interpreter automation tests headlessly and prints the pass/fail counts.
...
%EDITOR% "%PROJECT%" -ExecCmds="Automation RunTests GhostInTheStack.Interpreter; Quit" -unattended -nopause -nullrhi -NoSound -nosplash -log=GitsTests.log > nul 2>&1
