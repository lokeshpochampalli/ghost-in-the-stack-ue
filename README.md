...
- `docs/DECISIONS.md` is append-only. ADR-026 is the redesign decision; ADR-027 to 030 were decided by Claude at the developer's delegation; the next entry is ADR-031.
